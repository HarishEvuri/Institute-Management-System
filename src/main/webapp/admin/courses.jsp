...
<div class="container my-4 px-3">
    ...
    <div class="row justify-content-center">
        ...
        <button class="btn btn-primary ms-auto" onclick="location.href='/admin/courses/add'">Add Course
        </button>
                ...
                <c:forEach items="${courses}" var="course">
                    <tr>
                        ...
                        <td class="align-middle">
                            <button class="btn btn-success me-2" onclick="location.href='/admin/courses/${course.courseId}'">
                                Manage
                            </button>
                        </td>
                    </tr>
