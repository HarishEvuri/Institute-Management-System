...
<div class="container my-4 px-3">
    <div class="d-flex align-items-center">
        <h2 style="cursor : pointer;" onclick="location.href='/admin/professors'">Professors  >  </h2>
        <h3 class="ms-2">${professor.professorId}</h3>
    </div>
    <div class="row justify-content-center">
        <div class="card mt-4 col-lg-10 py-4 shadow" style="padding-left: 5%; padding-right: 5%">

            <div class="d-flex ms-auto">
                <button class="btn btn-primary me-2"  onclick="location.href='/admin/professors/${professor.professorId}/edit'">Edit Professor</button>
                <button class="btn btn-success me-2"  onclick="location.href='/admin/user/${user.username}/phone'">Manage Phone</button>
                <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteModal">Delete Professor</button>
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="deleteModalLabel">Delete Professor</h5>
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="btn btn-danger" onclick="location.href='/admin/professors/${user.username}/delete'">Delete</button>
                    </div>
                    </div>
                </div>
                </div>
                ...
                <div class="col-lg-6">
                    <table class="table table-borderless mb-0">
                        ...
                        <tr>
                            ...
                            <td style="width: 60%">
                                <c:forEach var="professorPhoneNumber" items="${professorPhoneNumbers}">
                                    <div class="pt-1">${professorPhoneNumber.phoneNumber}</div>
                                </c:forEach></td>
                            </td>
                        </tr>
                    </table>
                ...
                <div class="col-lg-6">
                    <table class="table table-borderless">
                        <tr>
                            ...
                            <td style="width: 60%">${professor.professorId}</td>
                        </tr>
                        <tr>
                            <th style="width: 40%">Department Id</th>
                            <td style="width: 60%">${professor.departmentId}</td>
                        </tr>
                        <tr>
                            <th style="width: 40%">Qualification</th>
                            <td style="width: 60%">${professor.qualification}</td>
                        </tr>
                        <tr>
