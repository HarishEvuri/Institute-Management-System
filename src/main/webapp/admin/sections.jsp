...
<div class="container my-4 px-3">
    ...
    <div class="row justify-content-center">
        ...
        <button class="btn btn-primary ms-auto" onclick="location.href='/admin/sections/add'">Add Section
        </button>
            ...
            <table id="example" class="table table-hover">
                ...
                <c:forEach items="${sections}" var="section">
                    <tr>
                        ...
                        <td class="align-middle">${section.professor.professorId}</td>
                        <td class="align-middle">${section.roomNumber}</td>
                        <td class="align-middle">${section.isLocked}</td>
                        <td class="align-middle">
                            <button class="btn btn-success me-2" onclick="location.href='/admin/sections/${section.course.courseId}/${section.sectionId}'">
                                Manage
                            </button>
                        </td>
                    </tr>
