...
<div class="container my-4 px-3">
    ...
    <div class="row justify-content-center">
        <div class="card mt-4 col-lg-10 py-4 shadow" style="padding-left: 5%; padding-right: 5%">
            ...
            <form:form action="${submiturl}" method="post" modelAttribute="staff">            
            <div class="row mt-3">
                    ...
                    <table class="table table-borderless">
                        <tr>
                            ...
                            <td style="width: 60%">
                                <c:choose>
                                <c:when test="${not empty edit}">
                                    <form:input type="text" path="staffId" class="form-control" required="true" disabled="true"></form:input>
                                    <form:errors path="staffId" style="color: red;"></form:errors>
                                </c:when>
                                <c:otherwise>
                                    <form:input type="text" path="staffId" class="form-control" required="true" placeholder="Staff Id"></form:input>
                                    <form:errors path="staffId" style="color: red;"></form:errors>
                                </c:otherwise>
                                </c:choose>
                            </td>
                        ...
                        <tr>
                            ...
                            <td style="width: 60%">
                                <form:input type="text" path="designation" class="form-control" required="true" placeholder="Designation"></form:input>
