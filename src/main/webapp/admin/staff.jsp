...
<div class="container my-4 px-3">
    ...
    <div class="row justify-content-center">
        ...
        <button class="btn btn-primary ms-auto" onclick="location.href='/admin/staff/add'">Add Staff
        </button>
            ...
            <table id="example" class="table table-hover">
                ...
                <c:forEach items="${staffs}" var="staff">
                    <tr>
                        ...
                        <td class="align-middle">
                            <button class="btn btn-success me-2" onclick="location.href='/admin/staff/${staff.staffId}'">
                                Manage
                            </button>
                        </td>
                    </tr>
