...
<div class="container my-4 px-3">
    ...
    <div class="row justify-content-center">
        ...
        <button class="btn btn-primary ms-auto" onclick="location.href='/student/complaints/add'">Raise Complaint
        </button>
            ...
            <table id="example" class="table table-hover">
                ...
                <c:forEach items="${complaints}" var="complaint">
                    <tr>
                        ...
                        <td class="align-middle">
                            <button class="btn btn-success me-2" onclick="location.href='/student/complaints/${complaint.complaintId}'">
                                Manage
                            </button>
                        </td>
                    </tr>
